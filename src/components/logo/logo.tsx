...
export const Logo: FC<LogoProps> = ({ variant = 'primary', href }) => {
	const iconVariants = {
		initial: { scale: 1 },
		hover: { scale: 1.1 },
	};
	...
	const iconClasses = classnames({
		'fill-primary-700': variant === 'primary' || variant === 'gradient',
	...
	const textClasses = classnames({
		...
		'text-transparent bg-clip-text bg-gradient-to-r from-secondary-400 to-primary-600': variant === 'gradient',
	});
